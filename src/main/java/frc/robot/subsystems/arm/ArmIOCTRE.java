...
/**
 * CTRE-based implementation of the ArmIO interface for controlling a robot arm
 * mechanism. This
 * implementation uses TalonFX motors and a CANcoder for position feedback. The
 * arm consists of a
 * leader motor, a follower motor, and an encoder for precise angular
 * positioning.
 */
public class ArmIOCTRE implements ArmIO {
   ...
   /**
    * Updates the arm's input values with the latest sensor readings. This includes
    * position,
   ...
   /**
    * Sets the desired angle for the arm to move to. This should be based off
    * encoder rotations to
    * arm.
    *
   ...
   /**
    * Stops all arm movement by stopping the leader motor. The follower will also
    * stop due to the
